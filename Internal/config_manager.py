...
_KNOWN_KEY_ORDER = {
    ...
    "logging": (
        ...
        "debug_log_level",
        "debug_log_path",
        "debug_broker_enabled",
        "debug_rest_enabled",
        "debug_dispatch_enabled",
        "debug_tracebacks_enabled",
    ),
    "runtime": (
        "test_mode",
        "backend_health_timeout_seconds",
        "backend_reconnect_enabled",
        "simulate_stale_backend_once",
    ),
    "diagnostics": ("snapshot_probe_enabled",),
    "mergereport": ("enabled", "log_path", "timeout_seconds"),
    "dispatch": (
        "per_slice_wait_seconds",
        "continue_on_timeout",
        "timeout_result",
        "max_slice_runtime_seconds",
    ),
    "email": (
        "ack_enabled",
        "ack_on_pending",
